                    ...
                    <form action="ManterPais.do" method="post">
                        ...
                        <div class="row">
                            <div class="form-group col-md-12">
                                ...
                                <input type="text" class="form-control" name="nome" id="nome" required maxlength="100" placeholder="MMENGÃO REI DO RIO" value="${pais.nome }">
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="email" class="form-control" name="area" id="populacao"  placeholder="FLUZÃO FREGUÊS" value="${pais.area }">
                            </div>
                        </div>
                        <hr />
