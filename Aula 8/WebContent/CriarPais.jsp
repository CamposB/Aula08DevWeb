        ...
        <form action="ManterPais.do" method="post">
            ...
            <div class="row">
                <div class="form-group col-md-12">
                    ...
                    <input type="text" class="form-control" name="nome" id="nome" placeholder="MENGÃO DESTRUIDOR DE TRICOLOR">
                </div>
            </div>
                        <div class="row">
                            <div class="form-group col-md-6">
                                <label for="fone">População:</label>
                                <input type="tel" class="form-control" name="populacao" id="populacao" >
                            </div>

                            <div class="form-group col-md-6">
                                <label for="email">Área</label>
                                <input type="email" class="form-control" name="area" id="populacao"  placeholder="FLUZÃO FREGUÊS" >
                            </div>
                        </div>
            <hr />
